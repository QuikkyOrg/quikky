      ...
      <div className="_Appbar flex justify-between">
        ...
        <div className="_icons flex gap-8 items-center pr-4">
          <div className="group">
            ...
            />
            {mode === 'light' ? (
              <span class="absolute top-16 scale-0 rounded text-xs p-2 group-hover:scale-100" style={theme[mode].appBar.icons}>
                Dark Mode
              </span>
            ) : (
              <span class="absolute top-16 scale-0 rounded p-2 text-xs group-hover:scale-100" style={theme[mode].appBar.icons}>
                Light Mode
              </span>
            )}
          </div>
          <div className="group">
            <img
              src={mode === 'light' ?('assets/settings.svg'):('assets/settingsDark.svg')}
              alt="Settings"
              className=" w-8"
          ...
          <div className="group">
            <img
              src={mode === 'light' ?("assets/logout.svg"):('assets/logoutDark.svg')}
              alt="LogOut"
              className=" w-8"
